...
class Dog {
    private String name; // when instance variables are called 
    ...
    void setData2(String name, String color, int age, int cost, String breed) { // generic setter
        this.name = name;
        this.color = color;
        this.breed = breed;
        this.cost = cost;
